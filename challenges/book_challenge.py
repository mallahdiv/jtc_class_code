...
my_library.add(title = 'The New Jim Crow', author = 'Michelle Anderson')
...
nyt_bestsellers.add(title = 'Just Mercy', author = 'Bryan Stevenson')
nyt_bestsellers.add(title = 'The New Jim Crow', author = 'Michelle Anderson')
