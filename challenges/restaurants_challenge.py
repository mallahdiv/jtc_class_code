...
# print(f"The Four Barrel coffee is locate at {restaurant['address1']}, {restaurant['state']},{restaurant['city']} {restaurant['zip_code']}")
...
fav_restaurants['tgif'] = ['256 Lord st', 'Hamburger', '10am-10pm']
fav_restaurants['TOA'] = ['111 Woodbine la', 'fish', '1pm-10pm']
fav_restaurants['Zing'] = ['345 Jake st', 'Turtle', '12pm-12am']
...
print(fav_restaurants['tgif'])

# TODO: Print the updated dictionary.
fav_restaurants['tgif'][2] = '1pm-9pm'
print(fav_restaurants['tgif'])
